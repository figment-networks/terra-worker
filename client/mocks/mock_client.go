...
// Source: github.com/figment-networks/terra-worker/worker/client/terra (interfaces: Api)
...
import (
	...
	terra "github.com/figment-networks/terra-worker/api"
...
func (m *MockApi) GetBlocksMeta(arg0 context.Context, arg1 structs.HeightRange, arg2 uint64, arg3 *terra.BlocksMap, arg4 chan<- error) {
	m.ctrl.T.Helper()
...
func (m *MockApi) SingularHeightWorker(arg0 context.Context, arg1 *sync.WaitGroup, arg2 chan terra.TxResponse, arg3 chan terra.ToGet) {
	m.ctrl.T.Helper()
